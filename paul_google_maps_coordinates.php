...
define('GOOGLE_KEY', 'ABQIAAAAc4mCVXra6vKZhc1Cxd_weRQoUZmTkW8okIwEvDaIs_MOSYysehQxztnrMsZIL-CtqVnynGvyB0r1UQ');
...
function paul_google_maps_coordinates_place($content){
	if(!is_feed()) {
		$content = preg_replace("/\[paul_google_maps_coordinates\]/ie", "paul_google_maps_coordinates()",$content);
    return $content;
	}
}
